...
void ImportMap()
{
	std::ifstream f("Assets/Maps/test_for_engine_export.json");
	assert(std::filesystem::exists("Assets/Maps/test_for_engine_export.json"));
	json data = json::parse(f);

	auto map = data.get<tiled::TiledMap>();
}
